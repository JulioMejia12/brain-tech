...
export default function PromotionForm() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            form.append('negocioId', BAZARCITO_NEGOCIO_ID)
    ...
    async function confirmDelete() {
        ...
        try {
            ...
            const res = await fetch(`/api/promotions/${createdId}?negocioId=${encodeURIComponent(BAZARCITO_NEGOCIO_ID)}`, { method: 'DELETE' })
            if (res.status === 204) {
