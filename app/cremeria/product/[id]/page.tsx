...
import { getCremeriaProductById, getCremeriaProducts } from '@/app/cremeria/services/products'
...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
    ...
    const product = await getCremeriaProductById(id)
    if (!product) {
        return {
