...
export const cremeriaProductsSellProps: ProductsSellPageConfig = {
    ...
    heroImage: 'https://res.cloudinary.com/ddfj0omil/image/upload/cremeria_tse1ps',
    mobileHero: {
        title: 'Cremería online',
        logoSrc: 'https://res.cloudinary.com/ddfj0omil/image/upload/cremeria_tse1ps',
        logoAlt: 'Logo Cremería',
        eyebrow: 'Catálogo online',
        heading: 'Descubre Cremería',
        description: 'Productos lácteos y más para tu hogar.',
        imageSrc: 'https://res.cloudinary.com/ddfj0omil/image/upload/cremeria_tse1ps',
