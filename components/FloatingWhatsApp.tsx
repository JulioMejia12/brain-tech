...
export default function FloatingWhatsApp({ whatsappNumber, message }: Props) {
  ...
  return (
    <button
      ...
      className="fixed z-50 right-6 bottom-6 md:right-8 md:bottom-8 bg-green-500 hover:bg-green-600 text-white rounded-full p-3 shadow-lg flex items-center justify-center"
